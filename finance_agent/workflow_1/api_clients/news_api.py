...
DEPRECATED: This module is no longer used in the main agent workflow.
The headlines_agent now uses Google Search (built-in ADK tool) instead,
which requires no API key and has better coverage.

This file is kept for reference and potential future use cases.
...
import warnings
warnings.warn(
    "news_api.py is deprecated. Use headlines_agent with Google Search instead.",
    DeprecationWarning,
    stacklevel=2
)
